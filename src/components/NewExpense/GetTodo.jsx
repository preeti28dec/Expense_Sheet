...
import { getUserTodos } from "../../network/api";
...
export default function GetTodo() {
  ...
  return (
    <>
      <div className="text-3xl font-bold my-2 text-center">
        User Todos list
      </div>
            ...
            return (
              ...
              >
                <div className="flex gap-2 flex-wrap">
                  ...
                  <div className="title">Name :{i.title}</div>
                  <div className="title">Email :{i.completed}</div>
                </div>
              </div>
            );
          })}
